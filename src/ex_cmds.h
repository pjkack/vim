...
EX(CMD_bnext,		"bnext",	ex_bnext,
			BANG|RANGE|NOTADR|COUNT|EDITCMD|TRLBAR,
			ADDR_LINES),
EX(CMD_borebuildsln,	"borebuildsln",	ex_borebuild,
			BANG|EXTRA,
			ADDR_LINES),
EX(CMD_borebuildproj,	"borebuildproj",ex_borebuild,
			EXTRA,
			ADDR_LINES),
EX(CMD_borebuildprojonly,"borebuildprojonly",ex_borebuild,
			EXTRA,
			ADDR_LINES),
EX(CMD_borebuildfile,	"borebuildfile",ex_borebuild,
			EXTRA,
			ADDR_LINES),
EX(CMD_borebuildinfo,	"borebuildinfo",ex_borebuild,
			0,
			ADDR_LINES),
EX(CMD_boreproj,	"boreproj",	ex_boreproj,
			BANG|WORD1,
			ADDR_LINES),
EX(CMD_boreconfig,	"boreconfig",	ex_boreconfig,
			BANG|WORD1,
			ADDR_LINES),
EX(CMD_borefind,	"borefind",	ex_borefind,
			NEEDARG|EXTRA,
			ADDR_LINES),
EX(CMD_boreopen,	"boreopen",	ex_boreopen,
			WORD1,
			ADDR_LINES),
EX(CMD_boresln,		"boresln",	ex_boresln,
			FILE1,
			ADDR_LINES),
EX(CMD_boretoggle,	"boretoggle",	ex_boretoggle,
			WORD1,
			ADDR_LINES),
...
EX(CMD_cunmenu,		"cunmenu",	ex_menu,
			EXTRA|TRLBAR|NOTRLCOM|USECTRLV|CMDWIN,
			ADDR_LINES),
EX(CMD_ctoggle,		"ctoggle",	ex_ctoggle,
			RANGE|NOTADR|COUNT|TRLBAR,
			ADDR_LINES),
...
EX(CMD_lvimgrepadd,	"lvimgrepadd",	ex_vimgrep,
			RANGE|NOTADR|BANG|NEEDARG|EXTRA|NOTRLCOM|TRLBAR|XFILE,
			ADDR_LINES),
EX(CMD_ltoggle,		"ltoggle",	ex_ctoggle,
			RANGE|NOTADR|COUNT|TRLBAR,
			ADDR_LINES),
...
EX(CMD_X,		"X",		ex_X,
			TRLBAR,
			ADDR_LINES),
EX(CMD_Boreopenselection,		"ZZBoreopenselection",		ex_Boreopenselection,
			0,
			ADDR_LINES),
EX(CMD_tilde,		"~",		do_sub,
			RANGE|WHOLEFOLD|EXTRA|CMDWIN|MODIFY,
